...
> [!NOTE]
> To resolve namespace conflicts between the various translations of Darby's Bible (DBY), for versions other than English, the first singular letter of the ISO 639-2 language code may be appended to the abbreviation (e.g., French version: "DBYF").
- Basque (baq):
